  ...
  return (
    <>
      <motion.nav  transition={{duration: 0.25}} className='mainNav'>
        <motion.div animate={clicked==1?{x:[0,-500,0]}:{x:[0,-500,10]}} className="lines">
            <Link onClick={menuHandler}  to={clicked==1?"/":"/Menu"}>
                <div style={clicked==1?{transform: 'rotate(45deg)', marginBottom:"0px", marginTop:"0px", transition: '1.2s'}:{marginBottom:"10px", marginTop:"10px", transition: '1.2s'}}  className='menuBar'></div>
                <div style={clicked==1?{transform: 'rotate(-45deg)', marginBottom:"0px", marginTop:"0px", transition: '1.2s'}:{marginBottom:"10px", marginTop:"10px", transition: '1.2s'}} className='menuBar'></div>
            </Link>
        </motion.div>
